      ...
      <div className="main">
        ...
        <div className="Languages">
          ...
          <a href="https://icons8.com/icons">
            <strong>Nodejs icon by Icons8</strong>
          </a>
          <img src="..//icons8-express-js-128.png" alt="" />
          <a href="https://icons8.com/icons">
            <strong>Express Js icon by Icons8</strong>
          </a>
          <img src="..//icons8-react-100.png" alt="" />
          <a href="https://icons8.com/icons">
            <strong>React icon by Icons8</strong>
          </a>
          <img src="..//icons8-json-web-token-144.png" alt="" />
          <a href="https://icons8.com/icons">
            <strong>JSON Web Token icon by Icons8</strong>
          </a>
