      ...
      return (
        ...
        <div className='edit-post'>
            ...
            <form onSubmit={handleSubmit} id='createPost' method='POST' >
                ...
                <input required type="text" id='postname' name='postname' value={postname} onChange={(e) => setPostname(e.target.value)}/> 
               ...
               <div>
                <input  type="checkbox" id='publish' checked={publish} onChange={checkHandler} name='publish' />
