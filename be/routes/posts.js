...
router.delete('/delete', postController.verifyToken, postController.mypostsDelete)
router.put('/publish', postController.verifyToken, postController.mypostsPubslih)
